...
function checkPasswordStrength() {
    ...
    if (!pattern.test(password)) {
        strengthIndicator.innerHTML = "Password must be at least 8 characters with uppercase, lowercase, and a number";
...
function togglePassword(fieldId) {
    ...
    if (input.type === "password") {
        input.type = "text";
        icon.src = "/static/img/visibility_off.svg";

    } else {
        input.type = "password";
        icon.src = "/static/img/visibility.svg";
    }
}
...
function changeLockIcon(inputElement) {
    inputElement.nextElementSibling.src = "/static/img/visibility_off.svg";
}
